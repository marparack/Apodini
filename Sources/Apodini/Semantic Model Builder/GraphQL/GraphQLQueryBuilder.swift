...
//////
//////
//////  Created by Sadik Ekin Ozbay on 16.11.20.
//////
////
////import GraphZahl
...
////        required init(viewerContext _: ()) {}
////
////        func data(name _: String) -> String {
////            "HI"
////        }
////    }
////
...
////    private let queryFunctions: [(String) -> String]
////    init(withQueryFunctions qf: [(String) -> String]) {
////        queryFunctions = qf
////    }
////
////    func buildQuery() -> HelloWorld.Type {
...
//            api = try MessageAPI(resolver: resolver)
